...
public class TitleAndTwoMessageDialog extends Dialog implements View.OnClickListener{
    ...
    public TitleAndTwoMessageDialog(@NonNull Context context) {
        super(context);
    }

    public TitleAndTwoMessageDialog(@NonNull Context context, @StyleRes int themeResId) {
        super(context, themeResId);
        activity=(Activity) context;
    }

    public TitleAndTwoMessageDialog initBtnText(String cancleText, String sureText) {
        this.cancle = cancleText;
        this.sure = sureText;
        return this;
    }
    public TitleAndTwoMessageDialog initTitleAndMessage(String title, String message) {
        this.title = title;
    ...
    public TitleAndTwoMessageDialog setOnBtnClickListener(TitleAndTwoMessageDialog.onBtnClickListener onBtnClickListener) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.usefuldialog_titleandtwomessage);
        initView();
        setText();
    }
