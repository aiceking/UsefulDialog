...
public class BigEditDialog extends Dialog implements View.OnClickListener {
    ...
    public BigEditDialog(@NonNull Context context) {
        super(context);
    }

    public BigEditDialog(@NonNull Context context, @StyleRes int themeResId) {
        super(context, themeResId);
        activity=(Activity) context;
    }

    public BigEditDialog initBtnText(String cancleText, String sureText) {
    ...
    public BigEditDialog initEditText(String s){
        this.editText=s;
        return this;
    }
    public BigEditDialog initTitle(String title) {
        this.title = title;
        return this;
    }
    ...
    public BigEditDialog setOnBtnClickListener(BigEditDialog.onBtnClickListener onBtnClickListener) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.usefuldialog_bigeidttext);
        initView();
        setText();
    }
